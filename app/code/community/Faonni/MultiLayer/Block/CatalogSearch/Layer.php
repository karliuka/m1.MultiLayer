 ...
 */
class Faonni_MultiLayer_Block_CatalogSearch_Layer 
	extends Faonni_MultiLayer_Block_View
{
    /**
    ...
    {
        return Mage::helper('faonni_multilayer')->isEnabled() 
			? 'faonni_multilayer/catalogsearch_layer_filter_attribute'
    ...
    protected function _initBlocks()
    {
        ...
        $this->_attributeFilterBlockName = Mage::helper('faonni_multilayer')->isEnabled()
			? 'faonni_multilayer/catalogsearch_layer_filter_attribute'
			: 'catalogsearch/layer_filter_attribute';
    }
